...
- `demo/basic.html` — solo time grid (day, 3 days, week, month, list, custom `dayCount` durations)
- `demo/resources.html` — resource grid with acceptance fixtures (1×7, 2×3, 2×5, 6×1, 6×3, 6×5, 12×1)
